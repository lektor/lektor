...
export function SpacingWidget(): React.JSX.Element {
  return <div className="spacing-widget" />;
}
SpacingWidget.isFakeWidget = true;

export function InfoWidget(props: { field: Field }): React.JSX.Element {
...
export function HeadingWidget(props: { field: Field }): React.JSX.Element {
